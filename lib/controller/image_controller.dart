...
import 'package:tribot/helper/custom_dialogue.dart';
import 'package:tribot/helper/global.dart';
...
class ImageController extends GetxController{
  ...
  void downloadImage() async {
    try {
      ...
      await GallerySaver.saveImage(file.path, albumName: "Tribot")
          .then((success) {
        //hide loading
        Get.back();
  ...
  void shareImage() async {
    try {
      ...
      await Share.shareXFiles([XFile(file.path)],
          text:
              'Check out this Amazing Image created by TriBot App by Sazid');
    } catch (e) {
      //hide loading
      Get.back();
      MyDialog.error('Something Went Wrong (Try again in sometime)!');
